...
import "../../Stylesheets/shopPhone/shopPhoneMain.scss";
...
function ShopPhoneMain() {
    ...
    // productData filtering here (allPhone)
    let allPhoneProducts = productData.filter((item) => item.category == "phone");
        ...
        <main>
            <MainContainer>
                ...
                <div className="allPhone">
                    <div className="allPhoneProductsContainer flex flex-wrap">
                        {
                            allPhoneProducts.filter((item) => {
