...
import "../../Stylesheets/shopSamsungTab/shopSamsungTabMain.scss";
...
function ShopSamsungTabMain() {
    ...
    // productData filtering here (samsungTab)
    let samsungTabProducts = productData.filter((item) => item.brand_name == "Samsung" && item.category == "tablet");
                ...
                <div className="samsungTab">
                    {
                        samsungTabProducts == "" ? (
                            ...
                            <div className="samsungTabProductsContainer flex flex-wrap">
                                {
                                    samsungTabProducts.filter((item) => {
...
export default ShopSamsungTabMain